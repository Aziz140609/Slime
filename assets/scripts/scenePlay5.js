var scenePlay5 = new Phaser.Class({
  Extends: Phaser.Scene,
  initialize: function () {
    Phaser.Scene.call(this, { key: "scenePlay5" });
  },

  preload: function () {
    // Tilemaps
    this.load.tilemapTiledJSON("map5", "assets/maps/map5.tmj"); // load map5
  ...
  create: function () {
    ...
    const coinSpawnLayers = [layer2, layer3, layer4, layer5].filter(Boolean);
