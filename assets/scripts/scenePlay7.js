var scenePlay7 = new Phaser.Class({
  Extends: Phaser.Scene,

  initialize: function () {
    Phaser.Scene.call(this, { key: "scenePlay7" });
  },

  preload: function () {
    this.load.tilemapTiledJSON("map7", "assets/maps/map7.tmj"); // load map6
  ...
  update: function () {
    ...
    if (this.player.x > 672) {
      this.registry.set('playerSpawn', { x: 20, y: this.player.y, targetScene: "scenePlay8" });
      this.registry.set('cameFrom_scenePlay8', this.scene.key);
      this.scene.start("scenePlay8");
    }
