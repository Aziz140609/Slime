var scenePlay3 = new Phaser.Class({
  ...
  create: function () {
    ...
    spawnEnemy(155, 250, 2); // Musuh 1
    spawnEnemy(375, 150, 1.5); // Musuh 2
    spawnEnemy(550, 150, 2); // Musuh 3
    spawnEnemy(400, 10, 3);
    spawnEnemy(200, 10, 1);
    spawnEnemy(305, 300, 3); 
    spawnEnemy(550, 300, 2);
  ...
  update: function () {
    ...
    if (this.player.x > 672) {
      this.registry.set('playerSpawn', { x: 20, y: this.player.y, targetScene: "scenePlay4" });
      this.registry.set('cameFrom_scenePlay4', this.scene.key);
    ...
    if (this.player.y > 320) {
      this.registry.set('playerSpawn', { x: this.player.x, y: 20, targetScene: "scenePlay6" });
      this.registry.set('cameFrom_scenePlay6', this.scene.key);
